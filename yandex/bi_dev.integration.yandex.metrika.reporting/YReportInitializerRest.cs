...
{
	public class YReportInitializerRest : YBaseReportInitializer
	{
		public YReportInitializerRest(YConfig config, YCounter counter, ICollection<YCustomDimension> dimensions, ICollection<YCustomMetric> metrics, DateTime dateStart) : base(config, counter, dimensions, metrics, dateStart)
		{
		}

		public override YCustomReport Get()
		{
			...
			YCustomReport customReport = new YCustomReport(this)
			{
			...
			{
				List<IYCustomParameterValued> reportRowCells = new List<IYCustomParameterValued>();
