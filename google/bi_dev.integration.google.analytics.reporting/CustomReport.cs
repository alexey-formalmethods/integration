...
namespace bi_dev.integration.google.analytics.reporting
{
    ...
    {
		protected BaseReportInitializer initializer;
		public CustomReport (BaseReportInitializer initializer)
		{
	...
	{
		public ICollection<ICustomParameterValued> Cells { get; set; }
		public CustomReportRow(ICollection<ICustomParameterValued> cells)
		{
			this.Cells = cells;
		}
	}
