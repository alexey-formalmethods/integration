...
namespace bi_dev.integration.google.analytics.reporting
{
	...
	public abstract class BaseReportInitializer
    {
		...
		public BaseReportInitializer(Config config, View view, ICollection<CustomDimension> dimensions, ICollection<CustomMetric> metrics, DateTime dateStart)
		{
			this.config = config;
			this.View = view;
		...
		public BaseReportInitializer(Config config, View view, ICollection<CustomDimension> dimensions, ICollection<CustomMetric> metrics, DateTime dateStart, DateTime dateEnd)
		{
			this.config = config;
			this.View = view;
			this.Dimensions = dimensions;
